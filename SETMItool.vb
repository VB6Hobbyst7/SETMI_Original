...
<ComClass(SETMItool.ClassId, SETMItool.InterfaceId, SETMItool.EventsId), System.Runtime.InteropServices.ProgId("SETMI.SETMItool")> _
Public NotInheritable Class SETMItool
...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.m_name = "SETMI"  'unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
